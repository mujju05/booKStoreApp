...
function Navbar() {
    ...
    const navItems = (
        <>
            ...
            <li key="course"><a href='/Course'> Course</a></li>
            <li key="contact"><a href='/Contactus'>Contact</a></li>
    ...
    return (
        <>
            ...
            >
        <div className="navbar md:dark:bg-slate-900 dark:text-white">
            <div className="navbar-start">
                ...
                <a className="text-4xl font-bold cursor-pointer flex"><img src={logo} className='w-10 h-10' alt="" />booKStore</a>
            </div>
